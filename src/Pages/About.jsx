    ...
    <>
              ...
              <div className="col-lg-6 col-md-6">
                <div className="main-abt-content-con">
                  ...
                  <div className="position-relative">
                    <figure><img src="/assets/images/main-abt-img1.jpg" alt="image" className="img-fluid br-30" /></figure>
                    <div className="vid-con bg-black br-30 text-center"><a href="https://video-previews.elements.envatousercontent.com/a8007808-5900-46c3-92dc-9c4dc55afd78/watermarked_preview/watermarked_preview.mp4" className="popup-vimeo d-inline-block"><img src="/assets/images/play-btn.png" alt="icon" className="img-fluid" /></a><span className="d-block text-white font-weight-bold">Watch Video</span></div>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-md-6">
                <div className="main-about-img-con">
                  <figure><img src="/assets/images/main-abt-img2.jpg" alt="image" className="img-fluid br-30" /></figure>
      ...
      <div className="padding-rl float-left w-100">
        <section className="float-left w-100 position-relative how-it-works-con br-30">
          <figure className="pharmz-icon"><img src="/assets/images/capsule-icon.png" alt="vector" className="position-absolute img-fluid" /></figure>
          <div className="container-fluid">
            <div className="row align-items-center">
              <div className="col-lg-7 col-md-6">
                <div className="work-img-con">
                  <figure><img src="/assets/images/work-img.jpg" alt="image" /></figure>
                </div>
              </div>
              <div className="col-lg-5 col-md-6">
                <div className="work-content-con">
                  ...
                  <ul className="list-unstyled p-0 mb-0 position-relative">
                    <li className="position-relative d-flex align-items-center">
                      <figure><img src="/assets/images/work-icon2.png" alt="icon" className="img-fluid" /></figure>
                      <div className="sub-info-inner">
                    ...
                    <li className="position-relative d-flex align-items-center">
                      <figure><img src="/assets/images/work-icon3.png" alt="icon" className="img-fluid" /></figure>
                      <div className="sub-info-inner">
                    ...
                    <div className="team-box text-center position-relative all_boxes">
                      ...
                      <ul className="list-unstyled p-0 mb-0">
                        {member.socialLinks?.facebook && (
                          <li className="d-inline-block"><a href={member.socialLinks.facebook} className="ml-0" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-facebook-f" /></a></li>
                        )}
                        {member.socialLinks?.instagram && (
                          <li className="d-inline-block"><a href={member.socialLinks.instagram} target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-instagram" /></a></li>
                        )}
                        {member.socialLinks?.linkedin && (
                          <li className="d-inline-block"><a href={member.socialLinks.linkedin} target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-linkedin" /></a></li>
                        )}
                        {member.socialLinks?.twitter && (
                          <li className="d-inline-block"><a href={member.socialLinks.twitter} target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-twitter" /></a></li>
                        )}
                      </ul>
                    </div>
                  </div>
                      ...
                      <div key={t._id} className={`carousel-item${i === 0 ? ' active' : ''}`}>
                        <div className="client-review-box">
                          <figure className="rating-stars">
                            {[...Array(5)].map((_, s) => (
                              <i key={s} className={`fa-star ${s < t.rating ? 'fa-solid' : 'fa-regular'}`} style={{ color: s < t.rating ? '#f59e0b' : '#d1d5db', fontSize: 16, marginRight: 2 }} />
                            ))}
                          </figure>
        ...
        <section className="float-left w-100 news-and-articles-con padding-top padding-bottom position-relative">
          <div className="main-container">
            ...
            {blogs.length === 0 ? (
              ...
              <div className="row">
                {blogs.map((post) => {
                  const imgUrl = post.image?.startsWith('/uploads')
                    ? `${import.meta.env.VITE_API_URL}${post.image}`
                    : post.image || '/assets/images/news-and-articles-img1.jpg'
                  return (
                    <div key={post._id} className="col-lg-4 col-md-6 col-sm-6 col-12 mx-auto">
                      <div className="article-box">
                        <div className="image position-relative">
                          <figure className="article-image">
                            <img src={imgUrl} alt={post.title} className="img-fluid" />
                          </figure>
                        </div>
                        <div className="box-content">
                          <Link to={`/blog/${post.slug || post._id}`} className="text-decoration-none">
                            <h4>{post.title}</h4>
                          </Link>
                          <p className="mb-0">{post.excerpt || (post.content ? post.content.slice(0, 120) + '...' : '')}</p>
                        </div>
                      </div>
                    </div>
                  )
