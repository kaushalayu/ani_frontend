      ...
      <section className="float-left w-100 footer-con position-relative br-30 padding-rl-responsive">
        <div className="main-container position-relative">
              ...
              <div className="col-lg-2 col-md-6 col-sm-6 col-12">
                <div className="links">
                  ...
                  <ul className="list-unstyled mb-0">
                    <li><i className="fa-solid fa-arrow-right" /><Link to="/" className="text-decoration-none">Home</Link></li>
                    <li><i className="fa-solid fa-arrow-right" /><Link to="/about" className="text-decoration-none">About</Link></li>
                    <li><i className="fa-solid fa-arrow-right" /><Link to="/shop" className="text-decoration-none">Shop</Link></li>
                    <li><i className="fa-solid fa-arrow-right" /><Link to="/shop" className="text-decoration-none">Team</Link></li>
                    <li><i className="fa-solid fa-arrow-right" /><Link to="/blog" className="text-decoration-none">Blog</Link></li>
                  </ul>
                </div>
              </div>
          ...
          <div className="copyright d-flex justify-content-between align-items-center padding-rl-responsive">
            ...
            <img src="/assets/images/payment-cards.png" alt="cards" className="img-fluid" />
          </div>
        </div>
      </section>
    </div>
